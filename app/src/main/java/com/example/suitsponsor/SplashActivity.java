...
public class SplashActivity extends AppCompatActivity {
    ...
    static {
        ...
        //sNeedReqPermissions.add(Manifest.permission.CHANGE_WIFI_STATE);
        //sNeedReqPermissions.add(Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS);
        //sNeedReqPermissions.add(Manifest.permission.INTERNET);
    }
