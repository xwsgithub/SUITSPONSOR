...
import com.example.suitsponsor.bean.AddressInfo;
import com.example.suitsponsor.bean.AddressInfoLab;
import com.example.suitsponsor.view.AddressView;
...
//        getSupportActionBar().hide();   //隐藏标题栏
        ...
        findViewById(R.id.baidu_map_back).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.baidu_map_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(baidumap.this,order_3D_machine.class));
            }
        });
    }
...
//                mMap.setMyLocationEnabled(false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(Menu.NONE, ITEM_SHOW_SHOPS, 0, "显示所有3D量体仓");
